    ...
    <div className="container flex justify-between items-center">
        <div className='flex items-center gap-4'>
            ...
            <div className='hidden lg:block'>
                <ul className='flex items-center gap-4'>
                    ...
                    <a className='flex items-center gap-[2px] font-semibold text-gray-500  dark:hover:text-white py-2' href="#">Quick Links
                    <span>
                    ...
                    <div className='absolute z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white shadow-md dark:bg-gray-900 p-2 text-black dark:text-white'>
                        <ul className='space-y-2'>
                            {DropdownLinks.map((data,index)=>{
                                return (
                                   <li key={index}><a className='text-gray-500 hover:text-black dark:hover:text-white duration-200 inline w-full p-2 hover:bg-primary/20 '  href={data.link}>{data.name}</a></li>
                                )
                            })}
                        </ul>
                    </div>
        ...
        <div className='flex justify-between items-center gap-4'>
            <div className='relative group hidden sm:block'>
                ...
                <IoMdSearch className='text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 absolute top-1/2 -translate-y-1/2 right-3 duration-300'/>
            </div>
            <button className='relative p-3' onClick={handleorderpop}>
